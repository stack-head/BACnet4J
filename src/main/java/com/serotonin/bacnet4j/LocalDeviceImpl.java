 ...
 */
public class LocalDeviceImpl implements LocalDevice {
    static final Logger LOG = LoggerFactory.getLogger(LocalDeviceImpl.class);
    ...
    public LocalDeviceImpl(final int deviceNumber, final Transport transport) {
    ...
    public LocalDeviceImpl withClock(final Clock clock) {
        setClock(clock);
        return this;
    }
    ...
    public LocalDeviceImpl writePropertyInternal(final PropertyIdentifier pid, final Encodable value) {
    ...
    public synchronized LocalDeviceImpl initialize() throws Exception {
        return initialize(RestartReason.unknown);
    }

    public synchronized LocalDeviceImpl initialize(final RestartReason lastRestartReason) throws Exception {
    ...
    public LocalDeviceImpl withPassword(final String password) {
        this.password = password;
        return this;
    }

    public LocalDeviceImpl withAPDUSegmentTimeout(final UnsignedInteger apduSegmentTimeout) {
    ...
    public LocalDeviceImpl withAPDUTimeout(final UnsignedInteger apduTimeout) {
        deviceObject.writePropertyInternal(PropertyIdentifier.apduTimeout, apduTimeout);
        transport.setTimeout(apduTimeout.intValue());
        return this;
    }

    public LocalDeviceImpl withNumberOfApduRetries(final UnsignedInteger numberOfApduRetries) {
...

            {
                ...
                if (rd != null) {
                    ...
                    if (!deviceFindTimedOut(instanceNumber)) {
                        ...
                        future = RemoteDeviceFinder.findDevice(LocalDeviceImpl.this, instanceNumber);
                    }
                }
            }
