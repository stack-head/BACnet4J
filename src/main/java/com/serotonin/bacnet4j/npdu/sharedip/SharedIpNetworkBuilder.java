 ...
 */
package com.serotonin.bacnet4j.npdu.sharedip;
...
public class SharedIpNetworkBuilder {
    ...
    private static IpNetwork instance = null;

    public SharedIpNetworkBuilder withLocalBindAddress(final String localBindAddress) {
     ...
     * @return this
     */
    public SharedIpNetworkBuilder withBroadcast(final String broadcastAddress, final int networkPrefixLength) {
     ...
     * @return this
     */
    public SharedIpNetworkBuilder withSubnet(final String subnetAddress, final int networkPrefixLength) {
    ...
    public SharedIpNetworkBuilder withPort(final int port) {
        this.port = port;
        return this;
    }

    public SharedIpNetworkBuilder withLocalNetworkNumber(final int localNetworkNumber) {
        this.localNetworkNumber = localNetworkNumber;
        return this;
    }

    public SharedIpNetworkBuilder withReuseAddress(final boolean reuseAddress) {
    ...
    public synchronized IpNetwork build() {
        if (instance == null) {
            ...
            instance = new IpNetwork(port, localBindAddress, broadcastAddress, subnetMask, localNetworkNumber, reuseAddress);
        }

        return instance;
    }

    public synchronized IpNetwork getInstance() {
        return instance;
    }
